...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.typora-pic-upload.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".typora-pic-upload" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".typora-pic-upload")
	}
